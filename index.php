...
<html lang="en">
  ...
  <body>
      ...
      <div class="jumbotron" id="myContainer">
          <h1>WebGL</h1>
          <p>Create your online 3D arts.</p>
          <p>It's simple, gorgeous, and free!</p>
                  ...
                  <div class="modal-dialog">
                      <div class="modal-content">
                          <div class="modal-header">
                              ...
                              <h4 class="modal-title" id="signupModalTitle">Sign up today and start using our WebGL App!</h4>
                          </div>
